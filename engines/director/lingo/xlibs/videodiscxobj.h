...
void m_player(int nargs, bool allowRetVal);
void m_play(int nargs, bool allowRetVal);
void m_playRev(int nargs, bool allowRetVal);
void m_fastFwd(int nargs, bool allowRetVal);
void m_fastRev(int nargs, bool allowRetVal);
void m_slowFwd(int nargs, bool allowRetVal);
void m_slowRev(int nargs, bool allowRetVal);
void m_stepFwd(int nargs, bool allowRetVal);
void m_stepRev(int nargs, bool allowRetVal);
void m_playJog(int nargs, bool allowRetVal);
void m_playSpeed(int nargs, bool allowRetVal);
...
void m_stopAtFrame(int nargs, bool allowRetVal);
void m_searchWait(int nargs, bool allowRetVal);
void m_readPos(int nargs, bool allowRetVal);
void m_showDisplay(int nargs, bool allowRetVal);
void m_clear(int nargs, bool allowRetVal);
void m_videoControl(int nargs, bool allowRetVal);
void m_audioControl(int nargs, bool allowRetVal);
